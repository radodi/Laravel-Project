...
class DancerUpdateRequest extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return [
            ...
            'country.required' => 'Полето Държава е задължително за попълване!',
            'country.min' => 'Полето Държава трябва да е поне 3 знака!',
    ...
    public function rules()
    {
        return [
            ...
            'email' => 'required|email|unique:users,email,'.$this->route('dancer'),
